...
rate; even Hardened-RAG's keyword-only filter reaches only 75\% ABR against
obfuscated payloads.
...
$-20$\,pp vs.\ Hardened-RAG (75\%) in exchange for a substantially lower benign
...
operating-point landscape.  HardenedRAG achieves the highest ABR (75\%) but
...
HardenedRAG (FPR\,=\,5\%, ABR\,=\,75\%) sits between the two, with higher
...
All 530 benchmark tests are author-run. An independent evaluation by a
